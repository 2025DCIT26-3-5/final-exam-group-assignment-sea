...
export default function App() {
  ...
  return (
    <div className="h-screen bg-background flex flex-col app-safe">
      {/* Header */}
      <div className="sticky z-10 bg-background/95 backdrop-blur border-b px-4 py-3 flex-shrink-0" style={{ top: 'var(--safe-top)' }}>
      ...
      <div className="flex-1 overflow-hidden">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
          ...
          {/* Bottom Navigation */}
          <div className="flex-shrink-0 bg-background/95 backdrop-blur border-t bottom-nav">
